...
//       const res = await axios.post("http://localhost:5001/api/payments/checkout", {
//         bookingId: current.bookingId,
//         vendorId: vendor._id,
//         amount: vendor.price,
//       });

//       // 2️ Instantly redirect to Stripe (FAST)
...
//   return (
//     <div className="min-h-screen flex flex-col items-center bg-gray-50 font-sans p-4">
//       {/* Search Header */}
...
//               >
//                 {/* LEFT: Photos */}
//                 <div className="flex-shrink-0 w-full sm:w-1/2 p-4 flex flex-col gap-2">
//                   <div className="h-64 rounded-xl overflow-hidden shadow-md">
//                     <img
//                       src={currentPhoto}
//                       alt={vendor.hotelName}
...
//                 {/* RIGHT: Details */}
//                 <div className="flex-grow flex flex-col sm:flex-row p-4 sm:p-6 justify-between">
...
//                         {Array.from({ length: vendor.rating || 5 }).map(
//                           (_, i) => (
...
//                   {/* PRICE + ACTION */}
//                   <div className="flex-shrink-0 mt-6 sm:mt-0 sm:w-1/3 flex flex-col items-end gap-2 text-right">
...
//                       className={`mt-3 px-4 py-2 rounded-lg shadow font-medium ${
//                         status === "pending"
